	...
	return (
		<>
			...
			<div className='contact-container'>
				<div className='relative mx-auto w-full bg-white text-gray-700 rounded-t-lg'>
					<div className='grid grid-cols-2'>
						{/* :MAP CONTAINER */}
						<div className='order-1 col-span-full'>
							<iframe
								src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d20934.125327314858!2d90.40862494236035!3d23.809908491525707!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b8b087026b81%3A0x8fa563bbdd5904c2!2sDhaka!5e0!3m2!1sen!2sbd!4v1667859173500!5m2!1sen!2sbd'
								title='map'
								scrolling='no'
								frameBorder='0'
								width='100%'
						...
						<div className='order-3 md:order-2 col-span-full md:col-span-1 py-5 md:py-10 px-6'>
							<form className='mx-auto max-w-xl space-y-4' onSubmit={handleSubmit}>
								...
								{/* ::Submit Button */}
								<div>
									<button type='submit' className='py-2 px-6 rounded bg-green-400 text-base text-white font-semibold uppercase hover:bg-green-500'>
										Send Message
									</button>
								</div>
							</form>
						...
						<div className='order-2 md:order-3 col-span-full md:col-span-1 py-5 md:py-10 px-6'>
							<div className='mx-auto max-w-xl flex flex-col space-y-5'>
								...
								{/* ::Address */}
								<p className='text-sm text-gray-500 leading-6 italic'>
									18 Avenue Mirpur DOSH, <br /> 10/12 Ehsan Road <br /> Bangladesh
								</p>
								{/* ::Socials */}
								<div className='flex items-center'>
									{/* :Twitter */}
									<Link to='/' className='m-1.5 w-8 h-8 inline-flex justify-center items-center shadow-sm rounded-full bg-[#1DA1F2] text-white filter hover:brightness-125' style={{ backgroundColor: '#1DA1F2' }}>
										{/* ::twitter svg */}
									...
									{/* :FACEBOOK */}
									<Link to='/' className='m-1.5 w-8 h-8 inline-flex justify-center items-center shadow-sm rounded-full bg-[#4267B2] text-white filter hover:brightness-125' style={{ backgroundColor: '#4267B2' }}>
										{/* ::facebook svg */}
									...
									{/* :Instagram */}
									<Link to='/' className='m-1.5 w-8 h-8 inline-flex justify-center items-center shadow-sm rounded-full bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 text-white filter hover:brightness-125'>
										{/* ::instagram svg */}
										<svg className='w-4 h-4 fill-current' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
