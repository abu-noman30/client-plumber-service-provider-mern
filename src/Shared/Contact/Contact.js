	...
	return (
		<>
			...
			<div className='contact-container'>
				<div className='relative mx-auto w-full bg-white text-gray-700'>
						...
						<div className='order-2 md:order-3 col-span-full md:col-span-1 py-5 md:py-10 px-6'>
							<div className='mx-auto max-w-xl flex flex-col space-y-5'>
								...
								<p className='text-sm text-gray-500'>
									...
									absolutely love hearing from you! If you have any questions,
									comments or concerns, please let us know. We will get back to
								...
								<p className='text-sm text-gray-500 leading-6'>
									18 Avenue Mirpur DOSH, <br /> 10/12 Ehsan Road <br />{' '}
									Bangladesh
								</p>
								{/* ::Socials */}
